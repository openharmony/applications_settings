...
export class SystemAccountController {
   ...
   */
  async createQuest(callback: (account: account_osAccount.OsAccountInfo) => void) {
   ...
   */
  async createSystemAccount(localName: string, callback?: (account: account_osAccount.OsAccountInfo) => void) {
